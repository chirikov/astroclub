...
<td style="width: 151; height: 200;" align="left">Легенда:<br>
...
<img src="images/cal_ekv.gif" border="0" width="13" height="9"> Небесный экватор<br><br>
...
<td style="height:100;" id="tdt" valign="top" align="center"></td>
		...
		<tr><td>Фаза Луны:<br><img id="moon" src="phase.php?day=<?=$day?>&month=<?=$month?>"></td></tr>
<tr><td>
<table cellpadding="0" cellspacing="0" class="text"><tr><td>&nbsp;
<div id="cursor"><table class=text><tr><td align=right valign=top>Позиция курсора:&nbsp;</td><td>Азимут: 0&deg;, Высота: 0&deg;<br>Прямое восхождение: 0 ч., Склонение: 0&deg;</td></tr></table></div><br>
<form name="f2">
...
</select><br><b>Время:</b> <input type="Text" maxlength="2" size="2" name="hour" value="<?=$hour?>">:<input type="Text" maxlength="2" size="2" name="minute" value="<?=$minute?>">&nbsp;<input type="Submit" value="Перейти" name="goto" onclick="javascript:
var str = '';
