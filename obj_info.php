...
<html>
<head>
	<title>Информация об объекте <?=ereg_replace("@", " ", $obj)?></title>
</head>
...
$query = @mysql_query("select * from objects where ngc = '$code'") or ferror(2);
$ar = @mysql_fetch_assoc($query) or ferror(3);
...
?>
<td colspan="2" align="center"><input type="Button" value="Закрыть" onclick="self.close(); return false;"></td>
</table>
